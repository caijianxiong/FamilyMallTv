...
public abstract class BaseNormalActivity extends AppCompatActivity {
    ...
    private OnProcessDialogDismissListener onProcessDialogDismissListener;
    ...
    protected void onResume() {
        super.onResume();
        logUtil.d_2("BaseNormalActivity", mContext.getClass().getSimpleName());
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (progressDialog == null) {
                    ...
                    progressDialog = builder.CreateDialog(BaseNormalActivity.this);
                }
                progressDialog.tv_mydialog_text.setText(msg);
                progressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                    @Override
                    public void onCancel(DialogInterface dialog) {
                        if (onProcessDialogDismissListener != null) {
                            onProcessDialogDismissListener.dismiss();
                        }
                        dialog.dismiss();
                    }
                });
    ...
    public void showErrorDialog(final String errorStr) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
    ...
    public void showMsgToast(final String msg) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(BaseNormalActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void setOnProcessDialogDismissListener(OnProcessDialogDismissListener onProcessDialogDismissListener) {
        this.onProcessDialogDismissListener = onProcessDialogDismissListener;
    }
}
