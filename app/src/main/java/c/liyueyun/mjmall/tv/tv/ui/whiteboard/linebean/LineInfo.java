package c.liyueyun.mjmall.tv.tv.ui.whiteboard.linebean;//package liyueyun.business.tv.ui.whiteboard.linebean;
//
...
//    }
//
//    public LineInfo(String lineId, int type, int color, int strokeWidth, ArrayList<PointInfo> pointLists) {
//        this.lineId = lineId;
//        this.type = type;
//        this.strokeWidth = strokeWidth;
//        this.color = color;
...
//    }
//
//    public LineInfo(String lineId, int color, int strokeWidth, MessageModel messageModel, ArrayList<PointInfo> pointLists) {
//        this.lineId = lineId;
//        this.strokeWidth = strokeWidth;
//        this.color = color;
